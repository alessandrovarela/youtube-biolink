...
- **`accent`** — `#EDD3A9` warm-amber canvas, `#1A1410` fg, `#B35536` accent (deep terracotta, WCAG AA 4.92:1 sobre branco). Cards/botões usam `--color-surface: #FFFFFF` sobre o canvas âmbar.
